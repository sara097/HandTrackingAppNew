...
//
//import com.example.HandsTrackingApp.basic.BasicActivity;
...
//                return "B";
//            } else if ((isThumbNearFinger(landmarkList.get(4), landmarkList.get(8)) && isThumbNearFinger(landmarkList.get(4), landmarkList.get(12))) && isThumbNearFinger(landmarkList.get(4), landmarkList.get(16))&& isThumbNearFinger(landmarkList.get(4), landmarkList.get(20)))   {
//                return "C";
//            } else if ( firstFingerIsOpen && (isThumbTouchingFinger(landmarkList.get(4), landmarkList.get(8)) && isThumbTouchingFinger(landmarkList.get(4), landmarkList.get(16))&& isThumbTouchingFinger(landmarkList.get(4), landmarkList.get(20)))) {
//                return "D";
//            } else if (!thumbIsOpen && firstFingerIsOpen && secondFingerIsOpen && !thirdFingerIsOpen && !fourthFingerIsOpen) {
//                return "H";
//            } else if (!thumbIsOpen && firstFingerIsOpen && secondFingerIsOpen && thirdFingerIsOpen && !fourthFingerIsOpen) {
...
//            } else if (!thumbIsOpen && firstFingerIsOpen && !secondFingerIsOpen && !thirdFingerIsOpen && !fourthFingerIsOpen) {
//                return "G";
//            } else if (!firstFingerIsOpen && secondFingerIsOpen && thirdFingerIsOpen && fourthFingerIsOpen && isThumbNearFinger(landmarkList.get(4), landmarkList.get(8))) {
//                return "F";
//            } else {
...
//
//
//    private boolean isThumbNearFinger(LandmarkProto.NormalizedLandmark point1, LandmarkProto.NormalizedLandmark point2) {
//        double distance = getEuclideanDistanceAB(point1.getX(), point1.getY(), point2.getX(), point2.getY());
//        return distance < 0.1;
//    }
//
//    private boolean isThumbTouchingFinger(LandmarkProto.NormalizedLandmark point1, LandmarkProto.NormalizedLandmark point2) {
//        double distance = getEuclideanDistanceAB(point1.getX(), point1.getY(), point2.getX(), point2.getY());
